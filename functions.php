...
// added:
wp_enqueue_script( 'terranean-scripts', get_template_directory_uri() . '/scripts.js', array(), '1.0.0', true  );
}
...
/**
 * load blockstudio function file
 */

require get_template_directory() . '/inc/functions-blockstudio.php';